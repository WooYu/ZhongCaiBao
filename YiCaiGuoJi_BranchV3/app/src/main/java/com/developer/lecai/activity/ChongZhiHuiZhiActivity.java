...
public class ChongZhiHuiZhiActivity extends BaseActivity {
    ...
    public View getLayout() {
        view = View.inflate(ChongZhiHuiZhiActivity.this, R.layout.chongzhi_huizhi,null);
        return view;
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.tv_chongzhi_commit:
                ...
                MsgController.getInstance().getHuiZhi("微信", "", homeDataBean.getTrueName() + "", tv_chongzhi_zhuanzhangnum.getText().toString() + "", money, "微信", new HttpCallback(ChongZhiHuiZhiActivity.this) {
                    @Override
    ...
    public void initData() {
        ...
        MsgController.getInstance().getHomeData(new HttpCallback(ChongZhiHuiZhiActivity.this) {
            @Override
            public void onSuccess(Call call, String s) {
