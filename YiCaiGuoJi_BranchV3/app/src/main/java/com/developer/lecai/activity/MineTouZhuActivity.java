...
public class MineTouZhuActivity extends BaseActivity
    ...
    private List<MyGameNotesEntity> betList=new ArrayList<>();
    private TouZhuAdapter betAdapter;
    ...
    public View getLayout() {
        view = View.inflate(MineTouZhuActivity.this, R.layout.activity_betting_record, null);
        return view;
    }
    ...
    public void initView() {
        ...
        bet_note_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MineTouZhuActivity.this,BettingDetailsActivity.class);
                intent.putExtra("bettingdata",betList.get(position));
                startActivity(intent);
            }
        });
        betAdapter = new TouZhuAdapter(getApplicationContext(), betList);
    ...
    public void initListener() {
        ...
        touZhuJiLuDialog = new TouZhuDialog(MineTouZhuActivity.this, status);
    ...
    private void betNotesRequest(String caiType, String startTime, String endTime) {
        request = NoHttp.createJsonObjectRequest(XyMyContent.GAMENOTE_URL, RequestMethod.POST);
        request.add("account", account);
        request.add("type", caiType);
        request.add("page", "1");
    ...
    protected void PullTorequest(int i, String caiType, String startTime, String endTime) {
