...
public class ShowErWeiMaActivity extends BaseActivity {
    ...
    public View getLayout() {
        view = View.inflate(ShowErWeiMaActivity.this, R.layout.activity_show_er_wei_ma, null);
        return view;
    }
        ...
        switch (v.getId()) {
            case R.id.tv_show_baocun:
                if (!TextUtils.isEmpty(imageUrl)) {
                    SDFileHelper helper = new SDFileHelper(ShowErWeiMaActivity.this);
                    helper.savePicture("weixin.jpg", imageUrl);
                }
                break;
            case R.id.tv_show_huizhidan:
                Intent intent = new Intent();
                intent.setClass(this, ChongZhiHuiZhiActivity.class);
    ...
    public void initData() {
        MsgController.getInstance().getHomeData(new HttpCallback(ShowErWeiMaActivity.this) {
            @Override
