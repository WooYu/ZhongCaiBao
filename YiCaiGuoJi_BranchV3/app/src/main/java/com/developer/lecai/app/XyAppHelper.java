...
import com.developer.lecai.app.db.InviteMessgeDao;
import com.developer.lecai.app.db.UserDao;
import com.developer.lecai.app.domain.RobotUser;
...
public class XyAppHelper {
	...
	private EaseUser getUserInfo(String username) {
		...
		if (username.equals(EMClient.getInstance().getCurrentUser())) {
			...
			System.out.println("用戶名" + SharedPreferencesUtils.getValue(appContext, "NICK_NAME"));
			System.out.println("用戶名" + SharedPreferencesUtils.getValue(appContext, "PIC"));
			return user;
		}
