package com.developer.lecai.app.db;
...
import com.developer.lecai.app.domain.InviteMessage;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(XyApplication.getInstance().getApplicationContext());
    }
