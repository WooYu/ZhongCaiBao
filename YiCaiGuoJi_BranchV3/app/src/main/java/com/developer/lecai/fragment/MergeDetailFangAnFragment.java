...
public class MergeDetailFangAnFragment extends MergeDetailBaseFragment {
    ...
    public void refreshData() {
        MsgController.getInstance().getHmbettdetail("PayFee", "1", new HttpCallback(getActivity()) {
            @Override
    ...
    public void loadData(String position) {
        MsgController.getInstance().getHmbettdetail("PayFee", position, new HttpCallback(getActivity()) {
            @Override
            public void onSuccess(Call call, String s) {
