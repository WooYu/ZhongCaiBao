...
public class MergeDetailJinDuFragment extends MergeDetailBaseFragment {
    ...
    public void refreshData() {
        MsgController.getInstance().getHmbettdetail("FSJD", "1", new HttpCallback(getActivity()) {
            @Override
    ...
    public void loadData(String position) {
        MsgController.getInstance().getHmbettdetail("FSJD", position, new HttpCallback(getActivity()) {
            @Override
            public void onSuccess(Call call, String s) {
