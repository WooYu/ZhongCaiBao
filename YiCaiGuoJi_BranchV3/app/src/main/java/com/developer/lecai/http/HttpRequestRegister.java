...
public class HttpRequestRegister {
    ...
    public HttpRequestRegister(Builder builder) {
        this.params = builder.params;
    }

    public static class Builder {
        private static HttpRequestRegister httpRequest;
        private Map<String, String> params = new HashMap<>();

        public Builder() {
            httpRequest = new HttpRequestRegister(this);
        }

        public HttpRequestRegister build() {
            if(httpRequest == null) {
                httpRequest = new HttpRequestRegister(this);
            }
            return httpRequest;
