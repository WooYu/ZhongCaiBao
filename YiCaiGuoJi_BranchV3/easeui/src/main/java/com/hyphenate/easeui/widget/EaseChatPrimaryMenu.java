...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    private void init(final Context context, AttributeSet attrs) {
        localManager = LocalBroadcastManager.getInstance(getContext());
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_send) {
            if (listener != null) {
                ...
                editText.setText("");
//                Toast toast=Toast.makeText(getContext(), "系统禁言中", Toast.LENGTH_SHORT);
...
//			setModeVoice();
            //���ݹ㲥��ͼ  MyConstants.BROADCAST_NAME  Ȼ���͹㲥   ��FiveActivity ���ܹ㲥
            Intent i = new Intent("TOU_ZHU_BTN");
            localManager.sendBroadcast(i);
